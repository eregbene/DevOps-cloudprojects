# Project-6: Continuous Delivery with Jenkins and Tools
...
sudo -i
sudo su - jenkins
git ls-remote -h --  git@github.com:eregbene/vprociproject.git HEAD
```
...
```sh
https://github.com/eregbene/vprofile-project-all
```
